...
# Collapse any duplicated profile page renderings.
s=s.replace(profile_page+' '+profile_page, profile_page)
if profile_page not in s:
    s=s.replace("{page==='new'&&<NewTicket category={category}setCategory={setCategory}subject={subject}setSubject={setSubject}message={message}setMessage={setMessage}createTicket={createTicket}/>} ", "{page==='new'&&<NewTicket category={category}setCategory={setCategory}subject={subject}setSubject={setSubject}message={message}setMessage={setMessage}createTicket={createTicket}/>} "+profile_page+' ')
...
# Only add Profile if it is not already present; otherwise keep the existing one.
if 'function Profile(' not in s:
