...
// PUBLIC STORE REMOVAL + MOBILE-ONLY HOME + TWO MUTED AUTOPLAY VIDEOS + DYNAMIC BRAND.
...
.actions{display:grid!important;grid-template-columns:1fr!important;width:100%!important;max-width:none!important;gap:10px!important}.action{width:100%!important;min-height:58px!important}.section{padding:34px 18px 6px!important}.sectionHead{display:block!important}.cards,.videoGrid,.supportGrid{display:grid!important;grid-template-columns:1fr!important;gap:12px!important}.feature{min-height:190px!important}.videoGrid{grid-template-columns:1fr!important}.videoBox{min-height:0!important;aspect-ratio:auto!important;display:grid!important;grid-template-columns:1fr!important;gap:12px!important}.videoBox iframe{width:100%!important;height:auto!important;min-height:0!important;aspect-ratio:16/9!important;display:block!important}.videoInfo{padding:20px!important}.stats{grid-template-columns:1fr 1fr!important}.footer{padding:38px 18px!important}.drawerPanel{width:min(330px,88vw)!important}.drawer a{font-size:13px!important}.supportCard{padding:22px!important}.section h2{font-size:24px!important}.siteLogoImage{height:36px!important;width:auto!important;max-width:150px!important;object-fit:contain!important;display:block!important}@media(max-width:360px){.hero h1{font-size:56px!important}.stats{grid-template-columns:1fr!important}}
 ...
 const brandScript=`<script id="mythos-dynamic-brand">(function(){async function apply(){try{const r=await fetch('/api/settings',{cache:'no-store'});if(!r.ok)return;const s=(await r.json()).settings||{};if(s.logoUrl){document.querySelectorAll('.logo').forEach(function(el){el.innerHTML='<img class="siteLogoImage" src="'+String(s.logoUrl).replace(/"/g,'&quot;')+'" alt="Mythøs">'})}if(s.iconUrl){let link=document.querySelector('link[rel="icon"]');if(!link){link=document.createElement('link');link.rel='icon';document.head.appendChild(link)}link.href=s.iconUrl;let apple=document.querySelector('link[rel="apple-touch-icon"]');if(!apple){apple=document.createElement('link');apple.rel='apple-touch-icon';document.head.appendChild(apple)}apple.href=s.iconUrl}}catch(e){}}apply()})();</script>`;
 html=html.replace('</body>',brandScript+'</body>');
...
console.log('Production build: mobile-only Mythos public site, public store removed, two muted autoplay videos, dynamic logo/favicon and official Code Q applied.');
