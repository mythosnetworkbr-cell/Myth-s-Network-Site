...
console.log(`Mythøs build verification OK — ${html.length} páginas HTML verificadas, acesso público validado, suporte protegido e Polícia com ${policeItems} itens.`);
