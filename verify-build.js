...
const required=['index.html','regras.html','admin.html','tickets.html','regras-policia.html'];
...
console.log(`Mythøs build verification OK — ${html.length} páginas HTML verificadas, suporte protegido e Polícia com ${policeItems} itens.`);
